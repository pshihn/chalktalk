...
// WHEN WE DON'T WANT TO RENDER A FRAME, WE CAN USE A FAKE CONTEXT.
   ...
   function clearFog() {
      ...
      setBackgroundColor(defaultPenColor == 'white' ? 'black' : 'white');
   }
...
////////////////////////////////////////////////////////////////
   ...
   function initEventHandlers(canvas) {
      ...
      canvas.onmousedown = function(event) {
         ...
         var clientX = event.clientX, clientY = event.clientY, clientZ = 0;
...
//    + " <input id='soundfileinput' type='file' style='visibility:hidden' /> </input>"
      ...
      sphereTracker = new SphereTracker(video_analysis_canvas);
...
var sketchDragY = 0;
   ...
   function assignCollection() {
      ...
      var stringifiedData = Utility.stringify(strokes);
...
*/
      ...
      // FETCH PRESSURE DATA PREVIOUSLY RECORDED FROM TT SENSOR.
      ...
      if (isDef(window[g.name].animate)) {
        ...
        // beyond reasonable doubt not to be buggy
         ...
         if (speakerNotes) {
            ...
            _g.font = '10pix Arial';
            _g_text(speakerNotes, 5 - _g.panX, h - 5 - _g.panY);
            annotateEnd();
         }
