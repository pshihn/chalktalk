...
/*
   _utility.stringify = stringify;
   _utility.copyFromData = copyFromData;
   _utility.copyWithoutFunctions = copyWithoutFunctions;
   _utility.hasProperties = hasProperties;
   _utility.isFunction = isFunction;
   _utility.spliceFunction = spliceFunction;
   _utility.objectId = objectId;
   return _utility;*/
   return {
      stringify            : stringify,
      copyFromData         : copyFromData,
      copyWithoutFunctions : copyWithoutFunctions,
